...
public class MockCouponQueueRepository implements CouponQueueRepository {
    ...
    public CouponQueue save(CouponQueue couponQueue) {
        if (couponQueue.getId() == null) {
            setId(couponQueue, idGenerator.getAndIncrement());
        }
    ...
    private void setId(CouponQueue couponQueue, Long id) {
        try {
            java.lang.reflect.Field idField = CouponQueue.class.getDeclaredField("id");
